...
/*load screen full smoke*/
// Simulate loading for 3 seconds, then show content
...
$(window).on('load',function(){
    $("#loader").delay(4500).fadeOut('slow');
    $("#loader").delay(4200).fadeOut('slow');
});
...
sr.reveal('.left-contact', {
    origin: 'left'
});
sr.reveal('.right-contact', {
    origin: 'right'
});
sr.reveal('.end-section', {
    origin: 'top'
});
